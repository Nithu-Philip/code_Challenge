...
public class word_Count {
	...
	// each different word
	static int getWords(String fileName,
		...
		throws FileNotFoundException
	{
		...
		System.out.println("Top Ten words (word and count)");
		System.out.println("----------------------------");
		for (Entry<String, Integer> word :
		...
		System.out.println("----------------------------");
		System.out.println("Last sentence of the top occurance word.");
		System.out.println("----------------------------");
		//Last sentence of the top occurance word.		
